...
*Note: You can view or download the [IPython notebook](./election2020-timeseries-bibb-county-example.ipynb) and relevant datasets to run these examples yourself.
