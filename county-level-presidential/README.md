 ...
 * `margin2012`         -- Percentage point difference between the Republican candidate and the Democrat presidential candidates in the 2012 general election
   ...
   *Note: The `county_presidential.csv.gz` data file is gzipped in order to stay under github.com's file size limits. The uncompressed file takes about 5 MB of storage space.*
